// ============================================================
//  MÎK AI — index.js  (Node.js / Render Backend)
//  Google Identity Services Auth + Groq AI + MongoDB
...
app.post("/auth/google", async (req, res) => {
  ...
  try {
    // Verify with Google directly — works with Google Identity Services
...
app.post("/chat", requireAuth, async (req, res) => {
  ...
  const systemPrompts = {
    ...
    quiz:    "You are MÎK AI Quiz Master. Generate multiple-choice questions. Format: Question, A/B/C/D options, then correct answer.",
  };
